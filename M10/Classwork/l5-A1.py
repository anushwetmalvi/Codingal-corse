...
#adding image and labels for main window
...
#function to display a messagebox and proceed if OK is cliked
def msg():
...
def topwin():
    ...
    l2.place(x=180, y=233)
    l3.place(x=180, y=266)

    t1.place(x=270, y=200)
    t2.place(x=270, y=233)
    t3.place(x=270, y=266)
